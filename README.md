...
📫 tsionbizuayehu3@gmail.com | [LinkedIn](https://www.linkedin.com/in/tsion-bizuayehu-1932b91aa/)
...
`Python` `JavaScript` `Java` `PHP` `React` `Node.js` `Spring Boot` `Django`

**Databases & Tools:**  
`MongoDB` `MySQL` `Docker` `Git` `Figma` `Postman` `Capella` `ArcGIS` `QGIS`

**AI & Modeling:**  
`CNNs` `scikit-learn` `TensorFlow` `Bayesian Networks` `Markov Models` `MBSE`
...
![gRPC](https://img.shields.io/badge/gRPC-00B3E3?style=for-the-badge&logo=grpc&logoColor=white)
...
![GitHub Streak](https://github-readme-streak-stats.herokuapp.com/?user=tsion2121&theme=radical)
![GitHub followers](https://img.shields.io/github/followers/tsion2121?label=Follow&style=social)
